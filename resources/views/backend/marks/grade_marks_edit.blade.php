                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="grade_name" class="form-control"
                                                                   required="" value="{{ $editData->grade_name }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="grade_point" class="form-control"
                                                                   required="" value="{{ $editData->grade_point }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="start_marks" class="form-control"
                                                                   required="" value="{{ $editData->start_marks }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="end_marks" class="form-control"
                                                                   required="" value="{{ $editData->end_marks }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="start_point" class="form-control"
                                                                   required="" value="{{ $editData->start_point }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="end_point" class="form-control"
                                                                   required="" value="{{ $editData->end_point }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="remarks" class="form-control"
                                                                   required="" value="{{ $editData->remarks }}">
                                                        </div>
                                                    </div>
