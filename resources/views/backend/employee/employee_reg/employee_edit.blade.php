                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <select name="gender" id="gender" required=""
                                                                ...
                                                                <option
                                                                    value="Male" {{ ($editData->gender == 'Male')? 'selected': '' }} >
                                                                    Male
                                                                </option>
                                                                <option
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <select name="religion" id="religion" required=""
                                                                ...
                                                                <option
                                                                    value="Islam" {{ ($editData->religion == 'Islam')? 'selected': '' }}>
                                                                    Islam
                                                                </option>
                                                                <option
                                                                    value="Hindu" {{ ($editData->religion == 'Hindu')? 'selected': '' }}>
                                                                    Hindu
                                                                </option>
                                                                <option
                                                                    value="Christan" {{ ($editData->religion == 'Christan')? 'selected': '' }}>
                                                                    Christan
                                                                </option>
                                                        ...
                                                        <div class="controls">
                                                            <select name="designation_id" required=""
                                                                ...
                                                                @foreach($designation as $desi)
                                                                    <option
                                                                        value="{{ $desi->id }}" {{ ($editData->designation_id == $desi->id)?'selected':'' }} >{{ $desi->name }}</option>
                                                                @endforeach
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="date" name="join_date" class="form-control"
                                                                       required="" value="{{ $editData->join_date }}">
                                                            </div>
                                                        </div>
